...
for k in range(len(time1)):
    ax.plot(x, time1[k] * np.ones(len(x)), T1[k], color = '0.5')
...
for i in range(len(time2)):
    ...
    ax.plot(xt, time_t, Tt, color = '0.5')
    ax.plot(xt[:index], time_t[:index], Tt[:index], color = 'g')
...
for m in range(len(time3)):
    ...
    for n in range(len(xt) - 1):
        if (label_time[n] == 1) & (Tt[n] < Tf):
            ax.plot(xt[n:n+2], time_t[n:n+2], Tt[n:n+2], color = 'g')
        elif label_time[n] == 2:
            ax.plot(xt[n:n+2], time_t[n:n+2], Tt[n:n+2], color = 'b')
        elif label_time[n] == 3:
            ax.plot(xt[n:n+2], time_t[n:n+2], Tt[n:n+2], color = 'r')
            ...
            if n < len(xt) - 2:
                if (label_time[n+2] == 3) | ((label_time[n+2] == 32) | (label_time[n+2] == 22)):
                    ...
                    ax.plot(xt[n:n+2], time_t[n:n+2], Tt[n:n+2], color = '0.5')
        elif (label_time[n] == 11) & (label_time[n+1] == 22):
            ax.plot(xt[n:n+2], time_t[n:n+2], Tt[n:n+2], color = 'b')
        elif (label_time[n] == 11) & (label_time[n+1] == 32):
            ax.plot(xt[n:n+2], time_t[n:n+2], Tt[n:n+2], color = 'b')
    ...
    ax.plot(xt[dry_idx], time_t[dry_idx], Tt[dry_idx], linewidth = 2, color = 'yellow')

ax.set_zlim(-8, 10)
ax.set_zticks([-8, -2, 4, 10])
ax.set_xlabel('Depth (m)', labelpad = 30, fontsize = 30)
ax.set_ylabel('Time (h)', labelpad = 30, fontsize = 30)
ax.set_zlabel(r'Temperature ($^\circ \mathrm{C}$)', labelpad = 20, fontsize = 30)
...
# for k in range(len(time1)):
#     ax.plot(x, time1[k] * np.ones(len(x)), color = '0.5')
...
#                     ax.plot(xt[n:n+2], time_t[n:n+2], color = 'b')
#                 else:
#                     ax.plot(xt[n:n+2], time_t[n:n+2], color = '0.5')
#         elif (label_time[n] == 11) & (label_time[n+1] == 22):
#             ax.plot(xt[n:n+2], time_t[n:n+2], color = 'b')
#         elif (label_time[n] == 20) & ((label_time[n+1] == 2) | (label_time[n+1] == 22)):
#             ax.plot(xt[n:n+2], time_t[n:n+2], color = 'b')
