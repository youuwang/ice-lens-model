...
public:
    ...
    void solve(ofstream& output_T, ofstream& output_ice_lens, ofstream& label_time, ofstream& crack_state_time, ofstream& x_time);
...
protected:
    ...
    double kappa_l;
    //! thermal conductivity of bulk sandstone
    double kappa_s_bulk;
    ...
    //! label for each node (0-dry material; 1-frozen fringe or saturated medium; 2-pure ice; 3-pure water)
...
protected:
    ...
    void solve3(ofstream& output_T, ofstream& label_time, ofstream& crack_state_time, ofstream& x_time);
